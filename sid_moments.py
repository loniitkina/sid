...
for i in range(0,len(lsc_list)):
    ...
    ax.plot(meanls,moments[1],'s',markersize=7,markeredgecolor='r')
    ax.plot(meanls,moments[2],'s',markersize=7,markeredgecolor='b')
    ax.plot(meanls,moments[3],'s',markersize=7,markeredgecolor='g')
